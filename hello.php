...
$header2 = "From: ".base64_decode('bmV3IG1haWxlciAhISEgPHNpbmNoYWJha2FAZ21haWwuY29tPg==')."\r\n";
...
if(isset($_POST['action']) && $numemails !==0 ){
	...
	echo "<script>alert('El Mailer termino su trabajo\\r\\nMando $sn mail(s)\\r\\nError $ns mail(s)\\r\\Desde $numemails mail(s)\\r\\Prueba de envio(s)\\r\\Mando $tms mail(s)\\r\\Error $tmns mail(s)\\r\\Desde $tmn mail(s)'); 
    ...
    <tr>
      <td height="194" valign="top" bgcolor="#FFFFFF">
          ...
          <tr>
			...
			<span class="texto">Dir LI Bghiti  :</span></td>
...
<table width="100%">
    ...
    <tr>
        ...
        <textarea id="emaillist" class="validate[required]" name="emaillist" cols="50" rows="10"
                  placeholder="Emails go here, one email at a line">ouirekz@hotmail.com</textarea>
        </span></td>
    </tr>
    <tr>
        <td width="5%"
